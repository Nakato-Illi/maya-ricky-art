...
<div class="container">
    <div class='row'>
        ...
        <div class='col-md-4'>
            ...
            <form accept-charset="UTF-8" action="/" class="require-validation" data-cc-on-file="false"  data-stripe-publishable-key="pk_test_51NRt9BJO5czArRdjhAGWV6TnVOK6h3xgKYfTmu1fBHPh5LfXujllKbNoe4uOQCvIZE9uKowmWrhhNP3BZllcQjwc00WPjVvYgf"  id="payment-form" method="post">
                @csrf
                <div class='form-row'>
                    <div class='col-xs-12 form-group required'>
                        <label class='control-label'>Card Holder Name</label> <input class='form-control' size='4' type='text' placeholder="Enter Card Holder Name">
                    </div>
                </div>
                <div class='form-row'>
